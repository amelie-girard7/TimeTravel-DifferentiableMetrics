...
def evaluate_and_save(model_dir, loader, best_checkpoint, file_label, best_epoch, phase):
    ...
    required_keys = ['input_ids', 'attention_mask', 'edited_ending', 'counterfactual', 'initial', 'premise',
                     'original_ending']
    ...
    for batch in loader:
        ...
        logger.info(
            f"Batch tensor shapes - input_ids: {gen_input_ids.shape}, attention_mask: {gen_attention_mask.shape}")
