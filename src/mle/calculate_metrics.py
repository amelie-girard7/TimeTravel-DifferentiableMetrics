# /data/agirard/Projects/TimeTravel-DifferentiableMetrics/src/mle/calculate_metrics.py
import os
import pandas as pd
import logging
...
def main():
    ...
    for repo in repo_paths:
        process_repository(repo, prefix='validation_details_mle')

    # Process test files
    for repo in repo_paths:
        process_repository(repo, prefix='test_details_mle')
