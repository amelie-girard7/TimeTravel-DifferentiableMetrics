...
def main():
    ...
    input_path = '/data/user/Projects/TimeTravel-DifferentiableMetrics/src/cpo/reward.csv'
    output_path = '/data/user/Projects/TimeTravel-DifferentiableMetrics/src/cpo/reward_scored.csv'
